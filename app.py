...
# ==============================================================================
app.config['://CLICK_TO:REVEAL_PASSWORD@mysql-3e9936af-viscorquality-0270.g.aivencloud.com:28643/defaultdb?ssl-mode=REQUIRED'] = 'sqlite:///reel_management.db' # 👈 ඔබගේ Aiven URL එක මෙතනට දාන්න
