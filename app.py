...
# ==============================================================================
# 🛠️ DATABASE CONNECTION & SSL AUTO-FIX 🛠️
# ==============================================================================
...
# mysql:// කොටස PyMySQL වලට ගැලපෙන සේ මාරු කිරීම
if raw_db_url.startswith('mysql://'):
    raw_db_url = raw_db_url.replace('mysql://', 'mysql+pymysql://', 1)

# PyMySQL ක්‍රාෂ් කරවන ssl-mode පරාමිතිය ඉවත් කිරීම
if '?ssl-mode=REQUIRED' in raw_db_url:
    raw_db_url = raw_db_url.replace('?ssl-mode=REQUIRED', '')
elif '&ssl-mode=REQUIRED' in raw_db_url:
    raw_db_url = raw_db_url.replace('&ssl-mode=REQUIRED', '')

app.config['SQLALCHEMY_DATABASE_URI'] = defaultdb
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

# PyMySQL සඳහා SSL සක්‍රීය කිරීමේ නිවැරදි සහ ආරක්ෂිත ක්‍රමය
app.config['SQLALCHEMY_ENGINE_OPTIONS'] = {
    "connect_args": {
        "ssl": {}  # Standard secure SSL/TLS connection
    }
}
# ==============================================================================
