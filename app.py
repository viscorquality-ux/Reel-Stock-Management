...
# ==============================================================================
# ⚠️ ඉතා වැදගත්: ඔබගේ AIVEN DATABASE CONNECTION URL එක පහතින් ඇතුළත් කරන්න ⚠️
# උදාහරණ (PostgreSQL සඳහා): 'postgresql://user:password@host:port/dbname?sslmode=require'
# උදාහරණ (MySQL සඳහා): 'mysql+pymysql://user:password@host:port/dbname'
# ==============================================================================
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://avnadmin:AVNS_gHRTw4Hzio_XlhXcm7d@mysql-3e9936af-viscorquality-0270.g.aivencloud.com:28643/defaultdb?ssl-mode=REQUIRED' app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)
...
def add_stock():
    ...
    if request.method == 'POST':
        try:
            ...
            # 🔍 FIX: එකම Reel Number එක නැවත ඇතුළත් කිරීම වැළැක්වීමේ පරීක්ෂාව (Unique Check)
