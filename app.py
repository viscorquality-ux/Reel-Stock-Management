...
# ==============================================================================
# ⚠️ මෙහි කිසිදු වෙනසක් කරන්න එපා!
# DATABASE_URL එක Render Environment Variable හරහා ස්වයංක්‍රීයව ලබා ගනී.
# ==============================================================================
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///reel_management.db')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
# පරීක්ෂා කිරීම සඳහා මෙය එක් කරන්න
db_url = os.environ.get('DATABASE_URL')
print(f"DEBUG: DATABASE_URL is: {db_url}")

if db_url and db_url.startswith('mysql'):
    # ... (පෙර පරිදිම ඔබ සැකසූ config කොටස)
db = SQLAlchemy(app)
