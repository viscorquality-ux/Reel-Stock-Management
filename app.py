...
# ==============================================================================
# ⚠️ ආරක්ෂිත Database සම්බන්ධතාවය (Render Environment Variables හරහා)
# මෙහිදී 'DATABASE_URL' කියන නමින් Render එකේ තියෙන URL එක කේතයට ගනී.
# යම් හෙයකින් එය Render එකේ නැත්නම්, Local පරිගණකයේ වැඩ කිරීමට SQLite භාවිතා කරයි.
# ==============================================================================
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///reel_management.db')
